...
object RetrofitClient {
    ...
    val StudyApi: StudyApiService = retrofit.create(StudyApiService::class.java)

    val CommunityApi: CommunityApiService = retrofit.create(CommunityApiService::class.java)
}