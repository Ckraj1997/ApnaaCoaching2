...
import com.chandan.apnaacoaching.ui.components.WelcomeBanner
...
fun HomeScreen(
    ...
    var isStudyGroupsExpanded by remember { mutableStateOf(true) }
    ...
    when (uiState) {
        ...
        is DashboardState.Success -> {
            val dashboardData = uiState.data
            LazyColumn(
                modifier = Modifier
                    .fillMaxSize()
                ...
                item {
                    ImageCarousel(images = dashboardData.carouselImages)
                }
                ...
                item {
                    Row(
                        modifier = Modifier
                            .fillMaxWidth()
                            .clickable {
                                isStudyGroupsExpanded = !isStudyGroupsExpanded
                            }
                        ...
                        Icon(
                            imageVector = if (isStudyGroupsExpanded) Icons.Default.KeyboardArrowUp else Icons.Default.KeyboardArrowDown,
                ...
                item {
                    ...
                    LatestUpdatesSection(updates = dashboardData.latestUpdates)
